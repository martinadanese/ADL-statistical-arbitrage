...
class Statistics:
    """
    class taken from https://github.com/pushpendughosh/Stock-market-forecasting
    See paper Ghosh, P., Neufeld, A., & Sahoo, J. K. (2021). Forecasting directional movements of stock prices for intraday trading using LSTM and random forests. Finance Research Letters, 102280.
